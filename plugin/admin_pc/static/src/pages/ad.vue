...
<script>
	...
	export default {
		...
		data() {
			return {
				// 列表请求地址
				url_get_list: "/apis/service/ad",
				url_del: "/apis/service/ad?method=del&",
				url_set: "/apis/service/ad?method=set&",
				url_import: "/apis/service/ad?method=import&",
				url_export: "/apis/service/ad?method=export&",
				field: "ad_id",
				query_set: {
					"ad_id": ""
				},
