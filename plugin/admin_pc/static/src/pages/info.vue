								...
								<mm_table type="2">
									<thead class="table-sm">
										<tr>
											...
											<th>
												<control_reverse title="销量" v-model="query.orderby" field="sales" :func="search"></control_reverse>
											</th>
											<th>
											...
											<th>
												<control_reverse title="服务定价" v-model="query.orderby" field="price" :func="search"></control_reverse>
											</th>
											<th>
									...
									<tbody>
										...
										<tr v-for="(o, idx) in list" :key="idx" :class="{'active': select == idx}" @click="selected(idx)">
											...
											<td>
												<mm_btn class="btn_primary" :url="'./info_form?info_id=' + o[field]">修改</mm_btn>
...
<script>
	...
	export default {
		...
		data() {
			return {
				// 列表请求地址
				url_get_list: "/apis/service/info",
				url_del: "/apis/service/info?method=del&",
				url_set: "/apis/service/info?method=set&",
				url_import: "/apis/service/info?method=import&",
				url_export: "/apis/service/info?method=export&",
				field: "info_id",
				query_set: {
					"info_id": ""
				},
