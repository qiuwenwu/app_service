						...
						<mm_card>
							...
							<div class="card_body">
								...
								<div class="bar_action">
									<h5><span>操作</span></h5>
									<div class="btns">
										<mm_btn class="btn_primary-x" url="./balance_form?">添加</mm_btn>
								...
								<mm_table type="2">
									<thead class="table-sm">
										<tr>
											...
											<th>
												<control_reverse title="账户余额" v-model="query.orderby" field="remain_cash" :func="search"></control_reverse>
											</th>
											<th>
												<control_reverse title="结款金额" v-model="query.orderby" field="settlement" :func="search"></control_reverse>
											</th>
											<th>
									...
									<tbody>
										...
										<tr v-for="(o, idx) in list" :key="idx" :class="{'active': select == idx}" @click="selected(idx)">
											...
											<td>
												<mm_btn class="btn_primary" :url="'./balance_form?account_id=' + o[field]">修改</mm_btn>
...
<script>
	...
	export default {
		...
		data() {
			return {
				// 列表请求地址
				url_get_list: "/apis/service/balance",
				url_del: "/apis/service/balance?method=del&",
				url_set: "/apis/service/balance?method=set&",
				url_import: "/apis/service/balance?method=import&",
				url_export: "/apis/service/balance?method=export&",
				field: "account_id",
				query_set: {
					"account_id": ""
				},
