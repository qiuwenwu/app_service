						...
						<mm_card>
							...
							<div class="card_body">
								...
								<div class="bar_action">
									<h5><span>操作</span></h5>
									<div class="btns">
										<mm_btn class="btn_primary-x" url="./achievement_form?">添加</mm_btn>
								...
								<mm_table type="2">
									<thead class="table-sm">
										<tr>
											...
											<th>
												<control_reverse title="收入" v-model="query.orderby" field="income" :func="search"></control_reverse>
											</th>
											<th>
												<control_reverse title="用户ID" v-model="query.orderby" field="user_id" :func="search"></control_reverse>
											</th>
											<th>
									...
									<tbody>
										...
										<tr v-for="(o, idx) in list" :key="idx" :class="{'active': select == idx}" @click="selected(idx)">
											...
											<td>
												<mm_btn class="btn_primary" :url="'./achievement_form?achievement_id=' + o[field]">修改</mm_btn>
...
<script>
	...
	export default {
		...
		data() {
			return {
				// 列表请求地址
				url_get_list: "/apis/service/achievement",
				url_del: "/apis/service/achievement?method=del&",
				url_set: "/apis/service/achievement?method=set&",
				url_import: "/apis/service/achievement?method=import&",
				url_export: "/apis/service/achievement?method=export&",
